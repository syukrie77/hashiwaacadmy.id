import { d as createAstro, e as createComponent, g as addAttribute, q as renderHead, r as renderTemplate, j as renderComponent, l as renderSlot, k as renderScript, v as Fragment } from './astro/server_VTTAJAsk.mjs';
import 'piccolore';
/* empty css                           */
...
Sign Up
</a> ` })}`} </div> </div> </nav> </header> <main> ${renderSlot($$result, $$slots["default"])} </main> ${renderScript($$result, "C:/Users/syukr/Proyek/E-Learning-Hashiwa-Figma/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts")} <footer> <div class="footer-grid"> <div class="footer-brand"> <div class="footer-logo">Hashiwa</div> <p>Pusat studi bahasa Jepang untuk kamu yang siap melangkah dari lokal ke global.</p> <a href="https://instagram.com/hashiwaacademy" target="_blank" rel="noopener noreferrer" class="footer-instagram">
📸 @hashiwaacademy
</a> </div> <div class="footer-section"> <h4>Navigasi</h4> <ul> <li><a href="/">Beranda</a></li> <li><a href="/dashboard">Dashboard</a></li> <li><a href="/contact">Kontak Kami</a></li> <li><a href="/register">Daftar Sekarang</a></li> </ul> </div> <div class="footer-section"> <h4>Kantor Indonesia</h4> <address>
Prima Harapan Regency<br>
Ruko PHR Loft EC-11<br>
Kota Bekasi, Indonesia
</address> <a href="https://wa.me/6208776022000" class="footer-phone">📞 0877 6022 000</a> </div> <div class="footer-section"> <h4>Kantor Jepang</h4> <address>
8F Keihan Yodoyabashi Building<br>
3-2-25 Kitahama, Chuo-ku<br>
Osaka-shi, Osaka 541-0041 Japan
</address> </div> </div> <div class="footer-bottom"> <p>&copy; ${(/* @__PURE__ */ new Date()).getFullYear()} Hashiwa Japanese Academy (PT Hashiwa Global Strategy). All rights reserved.</p> </div> </footer> </body></html>`;

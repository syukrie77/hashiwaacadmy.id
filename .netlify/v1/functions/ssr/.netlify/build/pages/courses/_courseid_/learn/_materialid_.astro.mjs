import { d as createAstro, e as createComponent, j as renderComponent, k as renderScript, r as renderTemplate, m as maybeRenderHead, g as addAttribute, u as unescapeHTML } from '../../../../chunks/astro/server_VTTAJAsk.mjs';
import 'piccolore';
...
Mark as Completed
</button> </div> </div>` : renderTemplate`<div class="text-content" data-astro-cid-mtz7efsy>${unescapeHTML(material.content)}</div>`} ${material.type === "text" && renderTemplate`<div class="actions" data-astro-cid-mtz7efsy> <button class="btn btn-primary mark-complete-btn" data-astro-cid-mtz7efsy>
Mark as Completed
</button> </div>`} </div> <div class="viewer-footer" data-astro-cid-mtz7efsy> <!-- Navigation between lessons could be added here --> </div> </div> <!-- End secure-content --> </main> </div> <div id="data-bridge" class="hidden"${addAttribute(courseId, "data-course-id")}${addAttribute(materialId, "data-material-id")}${addAttribute(JSON.stringify(completedMaterialIds), "data-completed-ids")} data-astro-cid-mtz7efsy></div> ` })} ${renderScript($$result, "C:/Users/syukr/Proyek/E-Learning-Hashiwa-Figma/src/pages/courses/[courseId]/learn/[materialId].astro?astro&type=script&index=0&lang.ts")} `;
